...
Game.prototype.setupUpgradeEventListeners = function() {
  ...
  document.getElementById('sellTower').addEventListener('click', () => {
    if (this.selectedTowerForUpgrade) {
      ...
      // Get the tower's grid coordinates
      const gridX = this.selectedTowerForUpgrade.gridX;
      const gridY = this.selectedTowerForUpgrade.gridY;

      // Mark the tile as grass again
      if (gridX !== undefined && gridY !== undefined) {
        this.map.removeTower(gridX, gridY);
      }
