...
// Create placeholder Game and Enemy classes if they don't exist yet
// This prevents errors when the script loads before game.js
if (typeof Game === 'undefined') {
  ...
  Game.prototype = {};
  console.log('Created placeholder Game class');
}
...
if (typeof Enemy === 'undefined') {
  ...
  console.log('Created placeholder Enemy class');
}
...
if (typeof GameMap === 'undefined') {
  ...
  console.log('Created placeholder GameMap class');
}
