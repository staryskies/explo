...
// Queue configuration
const config = {
  maxConcurrentRequests: 3, // Reduced from 5 to 3
  requestTimeout: 5000, // Increased from 3 to 5 seconds
  maxQueueSize: 50, // Reduced from 100 to 50
  maxRetries: 1, // Reduced from 2 to 1
  retryDelay: 1000, // Increased from 500ms to 1000ms
  operationTimeout: 2000 // Timeout for individual operations
};
