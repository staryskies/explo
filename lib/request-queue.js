...
// Queue configuration
const config = {
  maxConcurrentRequests: 3, // Reduced to 3 to prevent overloading Neon
  requestTimeout: 20000, // Increased to 20 seconds for Neon
  maxQueueSize: 50, // Reduced to 50 to prevent memory issues
  maxRetries: 3, // Increased to 3 retries
  retryDelay: 3000, // Increased to 3 seconds
  operationTimeout: 15000 // Increased timeout for individual operations
};
