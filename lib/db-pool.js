...
function initPool() {
  ...
  try {
    ...
    const connectionConfig = {
      ...
      idleTimeoutMillis: 30000, // How long a client is allowed to remain idle (increased for Neon)
      connectionTimeoutMillis: 30000, // How long to wait for a connection (increased for Neon)
      ...
      statement_timeout: 20000, // 20 seconds (increased for Neon)

      // Add query timeout to prevent long-running queries
      query_timeout: 20000, // 20 seconds (increased for Neon)

      // Add connection timeout to prevent hanging connections
      connect_timeout: 30, // 30 seconds (increased for Neon)
