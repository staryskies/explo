...
function initPool() {
  ...
  try {
    ...
    const connectionConfig = {
      ...
      max: 3, // Maximum number of clients in the pool (increased from 1 to 3)
      min: 0, // Minimum number of idle clients (no idle clients in serverless)
      idleTimeoutMillis: 1000, // How long a client is allowed to remain idle before being closed (increased slightly)
      connectionTimeoutMillis: 2000, // How long to wait for a connection (shorter timeout)
