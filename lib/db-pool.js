...
function initPool() {
  ...
  try {
    ...
    const connectionConfig = {
      ...
      // Critical settings for serverless environments - optimized for reliability
      max: 1, // Maximum number of clients in the pool (reduced to absolute minimum)
      ...
      // Add retry logic
      retryDelay: 1000, // Delay between connection retries in ms
